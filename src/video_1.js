...
app.get('/', function (req, res) {
    res.sendFile(__dirname + '/video_test_1.html');
})
...
app.get(['/flv','/flv/:feed/s.flv'], function (req, res) {
    ...
    //get emitter
    req.Emitter = initEmitter(req.params.feed)  //初始化一個 Eitter 並放在 Emitters[req.params.feed]的位置(index=req.params.feed)並輸出影
